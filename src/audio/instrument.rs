...
pub const SW : Instrument = Instrument::Pitched { waveform: Waveform::Pulse(0.5), enveloper: decay(0.5, 0.05)};
pub const BASS : Instrument = Instrument::Pitched { waveform: Waveform::Triangle(1.0), enveloper: decay(0.5, 0.05)};
